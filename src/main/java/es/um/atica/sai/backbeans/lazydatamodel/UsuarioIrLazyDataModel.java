...
public class UsuarioIrLazyDataModel extends FundeWebLazyDataModel<DatosUsuarioView> {
    ...
    {
    	ResultQuery<DatosUsuarioView> resultado = getServicioUsuario().busquedaUsuariosIr( first, pageSize, sortField, sortOrder);
    	this.setRowCount(getServicioUsuario().getCountBusquedaUsuariosIr().intValue());
    	if (resultado==null)
    	{
