...
@Name("cambioPasswordExterno")
@Scope(ScopeType.PAGE)
public class CambioPasswordExternoBean {
	...
	public String restablecerPassword()
	{
		...
		EntidadRespuesta er = usuarioService.restablecerPasswordAutenticado(this.passwordViejo, this.password1);
